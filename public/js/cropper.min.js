...
!function (t) {
    ...
    v.prototype = {
        constructor: v, init: function () {
            ...
            var t = this.options, i = this.container, e = i.width, s = i.height, a = this.cropBox,wz=this.canvas;
            (a.width > a.maxWidth || a.width < a.minWidth) && (a.left = a.oldLeft), (a.height > a.maxHeight || a.height < a.minHeight) && (a.top = a.oldTop), a.width = wt(wt(xt(a.width, a.minWidth), a.maxWidth),wz.width), a.height = wt(wt(xt(a.height, a.minHeight), a.maxHeight),wz.height), this.limitCropBox(!1, !0), a.oldLeft = a.left = wt(xt(a.left, a.minLeft), a.maxLeft), a.oldTop = a.top = wt(xt(a.top, a.minTop), a.maxTop), t.movable && t.cropBoxMovable && this.$face.data(it, a.width === e && a.height === s ? dt : lt);
            if(a.left<wz.left){
                a.left=wz.left;
            }
            if(a.top<wz.top){
            ...
            if(a.left+ a.width>wz.width+wz.left){
                a.left=wz.width+wz.left- a.width;
            }
            if(a.top+ a.height>wz.height+wz.top){
                a.top=wz.height+wz.top- a.height;
            }
            if(a.width!= a.height){
                var temp=wt(a.width, a.height);
                a.width=temp;
                a.height=temp;
            }
            this.$cropBox.css({
